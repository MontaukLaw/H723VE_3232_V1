...
/* RESERVED1 field mask */
#define CLOCK_RESERVED_MASK ((uint16_t)0x00C0)

/* TBM field mask & values */
#define CLOCK_TBM_MASK ((uint16_t)0x0020)
#define CLOCK_TBM_DISABLED ((uint16_t)0x0000 << 5)
#define CLOCK_TBM_ENABLED ((uint16_t)0x0001 << 5) // DEFAULT
...
extern volatile uint8_t ads131_data_ready;

bool readData(adc_channel_data *DataStruct);

void ads131_start_up(void);
